...
class User < ActiveRecord::Base
  ...
  def self.authenticate(login, password)
    ...
    if Configuration.authenticate_by_ldap?
      authenticate_by_ldap(login, password)
    else
  ...
  def self.authenticate_by_ldap(login, password)
    if LDAP.authenticates?(login, password)
